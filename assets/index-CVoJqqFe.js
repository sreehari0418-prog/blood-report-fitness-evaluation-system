 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,k){var y=z.length;z.push(k);e:for(;0<y;){var b=y-1>>>1,F=z[b];if(0<o(F,k))z[b]=k,z[y]=F,y=b;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var k=z[0],y=z.pop();if(y!==k){z[0]=y;e:for(var b=0,F=z.length,N=F>>>1;b<N;){var _=2*(b+1)-1,B=z[_],$=_+1,U=z[$];if(0>o(B,y))$<F&&0>o(U,B)?(z[b]=U,z[$]=y,b=$):(z[b]=B,z[_]=y,b=_);else if($<F&&0>o(U,y))z[b]=U,z[$]=y,b=$;else break e}}return k}function o(z,k){var y=z.sortIndex-k.sortIndex;return y!==0?y:z.id-k.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,s=a.now();e.unstable_now=function(){return a.now()-s}}var u=[],d=[],g=1,p=null,m=3,S=!1,w=!1,v=!1,x=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(z){for(var k=n(d);k!==null;){if(k.callback===null)r(d);else if(k.startTime<=z)r(d),k.sortIndex=k.expirationTime,t(u,k);else break;k=n(d)}}function j(z){if(v=!1,h(z),!w)if(n(u)!==null)w=!0,K(C);else{var k=n(d);k!==null&&q(j,k.startTime-z)}}function C(z,k){w=!1,v&&(v=!1,f(I),I=-1),S=!0;var y=m;try{for(h(k),p=n(u);p!==null&&(!(p.expirationTime>k)||z&&!W());){var b=p.callback;if(typeof b=="function"){p.callback=null,m=p.priorityLevel;var F=b(p.expirationTime<=k);k=e.unstable_now(),typeof F=="function"?p.callback=F:p===n(u)&&r(u),h(k)}else r(u);p=n(u)}if(p!==null)var N=!0;else{var _=n(d);_!==null&&q(j,_.startTime-k),N=!1}return N}finally{p=null,m=y,S=!1}}var T=!1,R=null,I=-1,A=5,L=-1;function W(){return!(e.unstable_now()-L<A)}function ne(){if(R!==null){var z=e.unstable_now();L=z;var k=!0;try{k=R(!0,z)}finally{k?P():(T=!1,R=null)}}else T=!1}var P;if(typeof c=="function")P=function(){c(ne)};else if(typeof MessageChannel<"u"){var D=new MessageChannel,Q=D.port2;D.port1.onmessage=ne,P=function(){Q.postMessage(null)}}else P=function(){x(ne,0)};function K(z){R=z,T||(T=!0,P())}function q(z,k){I=x(function(){z(e.unstable_now())},k)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){w||S||(w=!0,K(C))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(z){switch(m){case 1:case 2:case 3:var k=3;break;default:k=m}var y=m;m=k;try{return z()}finally{m=y}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,k){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var y=m;m=z;try{return k()}finally{m=y}},e.unstable_scheduleCallback=function(z,k,y){var b=e.unstable_now();switch(typeof y=="object"&&y!==null?(y=y.delay,y=typeof y=="number"&&0<y?b+y:b):y=b,z){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=y+F,z={id:g++,callback:k,priorityLevel:z,startTime:y,expirationTime:F,sortIndex:-1},y>b?(z.sortIndex=y,t(d,z),n(u)===null&&z===n(d)&&(v?(f(I),I=-1):v=!0,q(j,y-b))):(z.sortIndex=F,t(u,z),w||S||(w=!0,K(C))),z},e.unstable_shouldYield=W,e.unstable_wrapCallback=function(z){var k=m;return function(){var y=m;m=k;try{return z.apply(this,arguments)}finally{m=y}}}})(Os);Ms.exports=Os;var md=Ms.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zp=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),G=(e,t)=>{const n=M.forwardRef(({color:r="currentColor",size:o=24,strokeWidth:i=2,absoluteStrokeWidth:a,className:s="",children:u,...d},g)=>M.createElement("svg",{ref:g,...Ep,width:o,height:o,stroke:r,strokeWidth:a?Number(i)*24/Number(o):i,className:["lucide",`lucide-${zp(e)}`,s].join(" "),...d},[...t.map(([p,m])=>M.createElement(p,m)),...Array.isArray(u)?u:[u]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mp=G("Check",[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`+D),g(!1);return}const k=Gc(K);W({date:new Date().toLocaleDateString(),values:K,risks:k})}catch(D){console.error(D),alert("Error parsing image. Please try a clearer photo.")}finally{g(!1),m("")}},A=P=>{const D=P.target.files[0];D&&(D.type.startsWith("image/")?(o(D),h==="advanced"&&C==="online"?L(D):I(D)):alert("Please upload an Image (JPG/PNG) for OCR scanning."))},L=async P=>{g(!0),m("Sending to ML Neural Network...");const D=new FormData;D.append("file",P);const Q="https://blood-report-fitness-evaluation-system.onrender.com";try{const K=await fetch(`${Q}/analyze`,{method:"POST",body:D}),q=await K.json();if(!K.ok)throw new Error(q.error||"Server Error");if(console.log("ML Results:",q),!q.raw_results||q.raw_results.length===0){alert("ML Model returned no data (Model likely needs training). Switching to client-side OCR for this scan."),I(P);return}}catch(K){console.error(K),alert("Error connecting to Python Backend. Make sure 'server.py' is running!"),I(P)}finally{g(!1),m("")}},W=P=>{const D=Qc(P.values,P.risks);a(D);const Q=t&&t.email?`reports_${t.email}`:`temp_reports_${Date.now()}`,K=JSON.parse(localStorage.getItem(Q)||"[]"),q=[D,...K];u(q),localStorage.setItem(Q,JSON.stringify(q))},ne=P=>{var q,z;if(P.preventDefault(),!v)return;const D=parseFloat(v),Q=wo[S];let K="Normal";D<Q.min&&(K="Low"),D>Q.max&&(K="High"),c({parameter:S,value:D,unit:Q.unit,range:`${Q.min}-${Q.max}`,status:K,foods:Q.foods,fitnessImpact:K==="Low"?(q=Q.impact)==null?void 0:q.low:K==="High"?(z=Q.impact)==null?void 0:z.high:null})};return l.jsxs("div",{className:"blood-container fade-in",children:[l.jsxs("div",{className:"header-row",children:[l.jsx("button",{onClick:e,className:"back-btn",children:l.jsx(dt,{size:24})}),l.jsx("h2",{children:"Blood Evaluation"})]}),i?l.jsxs("div",{className:"results-section fade-in",children:[l.jsxs("div",{className:"results-header",children:[l.jsx("h3",{children:"Report Analysis"}),l.jsx("button",{className:"text-btn",onClick:()=>a(null),children:"Close"})]}),i.risks&&i.risks.length>0&&l.jsxs("div",{className:"risk-container fade-up",children:[l.jsx("h4",{children:"⚠️ AI Health Risk Detection"}),l.jsx("div",{className:"risk-grid",children:i.risks.map((P,D)=>l.jsxs("div",{className:"risk-card",style:{borderLeft:`4px solid ${P.color}`},children:[l.jsxs("div",{className:"risk-header",children:[l.jsx("span",{className:"condition-title",children:P.condition}),l.jsx("span",{className:"risk-badge",style:{background:P.color},children:P.risk})]}),l.jsx("p",{className:"risk-advice",children:P.advice}),l.jsx("button",{className:"view-details",onClick:()=>alert(`Detailed explanation for ${P.condition}: 

This condition was flagged based on your values. Please consult a doctor for verification.`),children:"View Details"})]},D))})]}),l.jsx("div",{className:"params-list",children:i.results.map((P,D)=>l.jsxs("div",{className:"param-card",children:[l.jsxs("div",{className:"param-header",children:[l.jsx("h4",{children:P.parameter.replace(/_/g," ").toUpperCase()}),l.jsxs("span",{className:`status-badge ${P.status.toLowerCase()}`,children:[P.status==="Normal"&&l.jsx(Pp,{size:14}),P.status==="High"&&l.jsx(_p,{size:14}),P.status==="Low"&&l.jsx(Fc,{size:14}),P.status]})]}),l.jsxs("div",{className:"param-value",children:[l.jsx("span",{className:"val",children:P.value}),l.jsx("span",{className:"unit",children:P.unit})]}),l.jsxs("p",{className:"range-info",children:["Ref Range: ",P.range]})]},D))}),i.suggestions.length>0&&l.jsxs("div",{className:"suggestions-box",children:[l.jsx("h3",{children:"🥗 Health & Fitness Recommendations"}),i.suggestions.map((P,D)=>l.jsxs("div",{className:"suggestion-item",children:[l.jsx("div",{className:"suggestion-header",children:l.jsxs("strong",{children:[P.status," ",P.parameter.replace(/_/g," ").toUpperCase()]})}),P.foods.length>0&&l.jsxs("p",{className:"food-list",children:["💡 ",l.jsx("b",{children:"Diety Tip:"})," Eat ",P.foods.join(", ")]}),P.fitnessImpact&&l.jsxs("p",{className:"fitness-list",children:["⚡ ",l.jsx("b",{children:"Fitness Impact:"})," ",P.fitnessImpact]})]},D))]})]}):l.jsxs("div",{className:"main-content",children:[l.jsxs("div",{className:"card manual-card",children:[l.jsx("h3",{children:"Quick Check"}),l.jsx("p",{className:"sub-label",children:"Enter a single value to check results instantly."}),l.jsxs("form",{onSubmit:ne,className:"manual-form",children:[l.jsxs("div",{className:"row",children:[l.jsx("select",{className:"input-field",value:S,onChange:P=>{w(P.target.value),c(null)},children:Object.keys(wo).map(P=>l.jsx("option",{value:P,children:P.replace(/_/g," ").toUpperCase()},P))}),l.jsx("input",{type:"number",step:"0.1",className:"input-field",placeholder:"Value",value:v,onChange:P=>x(P.target.value),required:!0})]}),l.jsxs("button",{type:"submit",className:"btn-primary small-btn",children:["Check ",l.jsx(Hp,{size:16})]})]}),f&&l.jsxs("div",{className:"manual-result fade-in",children:[l.jsx("div",{className:`result-badge ${f.status.toLowerCase()}`,children:f.status}),l.jsxs("p",{className:"result-text",children:[l.jsxs("strong",{children:[f.parameter.replace(/_/g," ").toUpperCase(),":"]})," ",f.value," ",f.unit,l.jsx("br",{}),l.jsxs("span",{className:"text-muted",children:["Normal: ",f.range]})]}),f.status!=="Normal"&&f.foods.length>0&&l.jsxs("div",{className:"diet-tip",children:[l.jsx("strong",{children:"Tip:"})," Eat ",f.foods.join(", ")]}),f.fitnessImpact&&l.jsxs("div",{className:"fitness-tip",children:[l.jsx("strong",{children:"Fitness Impact:"})," ",f.fitnessImpact]})]})]}),l.jsx("div",{className:"divider",children:"OR"}),l.jsxs("div",{className:"upload-card",children:[l.jsx("div",{className:"icon-circle",children:l.jsx(Ac,{size:32,color:"var(--color-primary)"})}),l.jsx("h3",{children:"Upload Report Image"}),l.jsx("p",{children:"Take a clear photo of your report. AI will scan for values."}),l.jsxs("div",{className:"scan-mode-toggle",children:[l.jsx("button",{className:`mode-btn ${h==="basic"?"active":""}`,onClick:()=>j("basic"),children:"Basic (Browser)"}),l.jsxs("button",{className:`mode-btn ${h==="advanced"?"active":""}`,onClick:()=>j("advanced"),children:["Advanced (Python ML)",C==="online"&&l.jsx("span",{className:"dot online",title:"Server Online"}),C==="offline"&&l.jsx("span",{className:"dot offline",title:"Server Offline (Run server.py)"})]})]}),l.jsxs("label",{className:"btn-secondary upload-btn",children:[d?p||"Scanning...":"Select Image (JPG/PNG)",l.jsx("input",{type:"file",accept:"image/*",hidden:!0,onChange:A,disabled:d})]})]}),s.length>0&&l.jsxs("div",{className:"history-section",children:[l.jsx("h3",{children:"Recent Reports"}),s.map((P,D)=>l.jsxs("div",{className:"history-item",onClick:()=>a(P),children:[l.jsx(Zl,{size:18,className:"text-muted"}),l.jsx("span",{children:P.date}),l.jsx("span",{className:"arrow",children:"→"})]},D))]})]}),l.jsx("style",{children:`
        .blood-container {
           padding: var(--spacing-md);
        }
        /* ... Existing Styles ... */
...
`),c={},h={hemoglobin:["hemoglobin","hb"],glucose_fasting:["glucose fasting","fbs"],cholesterol:["cholesterol"],uric_acid:["uric acid"],tsh:["tsh"]};if(f.forEach(I=>{const A=I.toLowerCase();Object.keys(h).forEach(L=>{if(h[L].some(W=>A.includes(W))){const W=I.match(/(\d+(\.\d+)?)/g);W&&(c[L]=parseFloat(W[0]))}})}),Object.keys(c).length===0){alert("Could not detect clear values. Please try a clearer image."),d(!1);return}const j=Qc(c);i(ws(j)),r(j);const C=t&&t.email?`reports_${t.email}`:`temp_reports_${Date.now()}`,T=JSON.parse(localStorage.getItem(C)||"[]"),R=[j,...T];localStorage.setItem(C,JSON.stringify(R))}catch(x){console.error(x),alert("Error scanning file.")}finally{d(!1)}}};return a?l.jsx("div",{className:"p-4",children:"Loading Diet Plan..."}):n?l.jsxs("div",{className:"diet-container fade-in",children:[l.jsxs("div",{className:"header-row",children:[l.jsx("button",{onClick:e,className:"back-btn",children:l.jsx(dt,{size:24})}),l.jsx("h2",{children:"Your Personalized Diet"})]}),l.jsx("div",{className:"health-summary",children:o.recommendations.some(w=>w.includes("⚠️"))?l.jsxs("div",{className:"alert-badge warning",children:[l.jsx(Fc,{size:16}),l.jsx("span",{children:"Based on your report: Modifications applied for specific conditions."})]}):l.jsxs("div",{className:"alert-badge success",children:[l.jsx(Mp,{size:16}),l.jsx("span",{children:"Report looks balanced. Showing base healthy plan."})]})}),l.jsxs("div",{className:"recommendations-box",children:[l.jsx("h4",{children:"Key Guidelines"}),l.jsx("ul",{children:o.recommendations.slice(0,3).map((w,v)=>l.jsx("li",{className:w.includes("⚠️")?"high-priority":"",children:w},v))})]}),l.jsx("div",{className:"meal-tabs",children:["breakfast","lunch","snacks","dinner"].map(w=>l.jsx("button",{className:`tab-btn ${g===w?"active":""}`,onClick:()=>p(w),children:w.charAt(0).toUpperCase()+w.slice(1)},w))}),l.jsx("div",{className:"meal-content",children:o[g].map((w,v)=>l.jsxs("div",{className:"food-card slide-in",children:[l.jsxs("div",{className:"food-header",children:[l.jsx("h3",{children:w.name}),l.jsxs("span",{className:"cal-badge",children:[w.calories," kcal"]})]}),l.jsxs("div",{className:"macros-row",children:[l.jsxs("span",{className:"macro",children:["C: ",w.carbs]}),l.jsxs("span",{className:"macro",children:["P: ",w.protein]}),l.jsxs("span",{className:"macro",children:["F: ",w.fat]})]}),l.jsx("div",{className:"benefits-tags",children:w.benefits.map((x,f)=>l.jsx("span",{className:"tag",children:x},f))})]},v))}),o.restrictions.length>0&&l.jsxs("div",{className:"restrictions-box",children:[l.jsx("h4",{children:"⛔ Avoid / Limit"}),l.jsx("p",{children:o.restrictions.join(", ")})]}),l.jsx("style",{children:`
            ...
            `})]}):l.jsxs("div",{className:"diet-container fade-in",children:[l.jsxs("div",{className:"header-row",children:[l.jsx("button",{onClick:e,className:"back-btn",children:l.jsx(dt,{size:24})}),l.jsx("h2",{children:"Specialized Diet"})]}),l.jsxs("div",{className:"no-report-state",children:[l.jsx("div",{className:"icon-box",children:l.jsx(Qn,{size:40,color:"var(--color-primary)"})}),l.jsx("h3",{children:"No Report Uploaded"}),l.jsx("p",{children:"Please upload your blood test report to get a personalized diet plan tailored to your body's needs."}),l.jsxs("label",{className:"btn-primary upload-btn-large",children:[u?"Scanning...":"Upload Report Now",l.jsx(Ac,{size:18,style:{marginLeft:8}}),l.jsx("input",{type:"file",accept:"image/*",hidden:!0,onChange:S,disabled:u})]})]}),l.jsx("style",{children:`
                ...
                `})]})};function sm(){const e=localStorage.getItem("user_profile"),[t,n]=M.useState(e?"dashboard":"login"),[r,o]=M.useState(null),[i,a]=M.useState(null),[s,u]=M.useState(e?JSON.parse(e):null),[d,g]=M.useState(null);Rs.useEffect(()=>{const v=localStorage.getItem("user_profile");v&&u(JSON.parse(v));const x=["Drink a glass of water now! 💧","Time to stretch your legs! 🚶","Don't forget to eat a fruit today! 🍎","Stay motivated! You're doing great. 💪","Check your blood report regularly. 🩸","Avoid sugary drinks for better health. 🥤❌"],f=setInterval(()=>{const c=x[Math.floor(Math.random()*x.length)];g(c)},12e4);return()=>clearInterval(f)},[]);const p=async(v,x=!1)=>{if(a(v),x){n("profile_setup");return}try{const f=await Mc.getProfile();f.success&&f.profile?(console.log("Profile found:",f.profile),u(f.profile),localStorage.setItem("user_profile",JSON.stringify(f.profile)),n("dashboard")):(console.log("No profile found, redirecting to setup"),n("profile_setup"))}catch(f){console.error("Error fetching profile:",f);const c=localStorage.getItem("user_profile");if(c){const h=JSON.parse(c);h.email===v.email?(u(h),n("dashboard")):(console.log("Cached profile does not match current user. Redirecting to setup."),n("profile_setup"))}else n("profile_setup")}},m=v=>{const x={...v,email:i==null?void 0:i.email};u(x),localStorage.setItem("user_profile",JSON.stringify(x)),n("dashboard")},S=(v,x=null)=>{o(x),n(v)},w=()=>{localStorage.removeItem("user_profile"),a(null),u(null),n("login")};return l.jsxs("div",{className:"app-container",children:[d&&l.jsx(lm,{message:d,onClose:()=>g(null)}),t==="login"&&l.jsx(bp,{onLogin:p}),t==="profile_setup"&&l.jsx(Cp,{onComplete:m}),t==="dashboard"&&l.jsx(Zp,{userName:s==null?void 0:s.name,userProfile:s,onNavigate:S,onLogout:w}),t==="bmi"&&l.jsx(qp,{userProfile:s,onBack:()=>n("dashboard")}),t==="blood"&&l.jsx(qh,{user:s,onBack:()=>n("dashboard"),initialViewReport:r}),t==="fitness"&&l.jsx(em,{userProfile:s,onBack:()=>n("dashboard")}),t==="homeworkout"&&l.jsx(nm,{onBack:()=>n("dashboard")}),t==="weightprogress"&&l.jsx(rm,{userProfile:s,onBack:()=>n("dashboard")}),t==="chat"&&l.jsx(im,{userProfile:s,onBack:()=>n("dashboard")}),t==="diet"&&l.jsx(am,{user:s,onBack:()=>n("dashboard")})]})}ci.createRoot(document.getElementById("root")).render(l.jsx(Rs.StrictMode,{children:l.jsx(sm,{})}));
